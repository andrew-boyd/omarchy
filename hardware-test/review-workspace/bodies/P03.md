...
This existing draft: [https://github.com/omacom/omarchy/pull/12681](https://github.com/omacom/omarchy/pull/12681).
...
Candidate head: `c10fd0fa5a5912d2a8a8668303df3366179ef7ef`; reconciled upstream: `8f324c90b82790d31ab33565441e07cbdb8d2308`. Published contribution commits and author/co-author metadata remain in the history.
...
Sysfs detection is shared plumbing. Do not interpret recognizing hardware as a claim that its graphics, camera, input or sleep behavior is validated.
...
| --- | --- | --- | --- |
| [omacom/omarchy#10807](https://github.com/omacom/omarchy/pull/10807) — @Chessing234 | closed | **context**: Closed Vulkan predecessor credited through omacom/omarchy#12076. | Already closed; retain evidence and credit. No action requested. |
| [omacom/omarchy#10808](https://github.com/omacom/omarchy/pull/10808) — @Chessing234 | closed | **context**: Closed T2 predecessor credited through omacom/omarchy#12076. | Already closed; retain evidence and credit. No action requested. |
| [omacom/omarchy#10810](https://github.com/omacom/omarchy/pull/10810) — @Chessing234 | closed | **context**: Closed BCM43xx predecessor credited through omacom/omarchy#12076. | Already closed; retain evidence and credit. No action requested. |
| [omacom/omarchy#11259](https://github.com/omacom/omarchy/pull/11259) — @neheb | open | **context**: Broader shared-helper architecture includes additional hardware paths beyond this selected source. | Keep the original as its review/test target; no closure recommendation here. |
| [omacom/omarchy#12076](https://github.com/omacom/omarchy/pull/12076) — @Chessing234 | open | **included**: Selected BCM43xx, T2, Vulkan and NVIDIA sysfs detection contribution, with later software checks/repairs for disappearing PCI attributes. Device-detection fixtures do not certify hardware support. | Consider closure only after maintainers accept preserved behavior and hardware coverage. |
