...
This draft: [omacom/omarchy#12690](https://github.com/omacom/omarchy/pull/12690). [All feature and package drafts](https://github.com/andrew-boyd/omarchy/blob/intel-mac/review-index/INTEL-MAC-ROLLUPS.md).

Package companion: [omacom/omarchy-pkgs#558](https://github.com/omacom/omarchy-pkgs/pull/558). Keep the merge/setup dependencies below.

## Rebuilt ISO and software follow-up — 2026-09-21 UTC

Current draft head: `ab359055f2fe29ad7389c495b9dbbce0d5477cea`. Original contribution commits and attribution are preserved.
...
- Tests ran at this rebased commit, `ab359055f2fe29ad7389c495b9dbbce0d5477cea`. The prior commits remain audit evidence; these results belong to that original publication tree, before the VM follow-up.
